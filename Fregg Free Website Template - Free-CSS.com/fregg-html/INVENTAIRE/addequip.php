        ...
        <nav>
            ...
            <div class="container">
                <div class="sidebar">
                    <ul>
                        <li><a href="../index.php">
                                <h1 style="text-align: center;">Pic Passion</hi>
                            </a></li><br>
                        <li>
                            <form action="equipement.php">
                ...
                <div class="content">
                    <section>
                        ...
                        <form action="formequip.php" method="POST">
                            ...
                            <label for="tailles_chaussons" id="OptionChossonsSupp" style="display: none;">Pointure :</label>
                            <input type="text" name="tailles_chaussons" id="tailles_chaussons" style="display: none;">
